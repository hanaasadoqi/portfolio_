...
const ProfileBadge: React.FC = () => (
  <div className="relative transform transition-transform hover:scale-105 md:mb-4">
    <Image
      ...
      height={192}
      priority
      className="rounded-full border-4 border-primary-100 shadow-lg"
      sizes="(max-width: 768px) 50vw, (max-width: 640px) 33vw, 192px"
    />
    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 whitespace-nowrap rounded-full bg-primary-300 px-4 py-1 font-bold text-primary-700 shadow-lg">
