...
const DarkModeToggle: React.FC = () => {
  ...
  return (
    <div id="dark-mode-toggle-container" className="fixed bottom-4 right-4 z-[999px]">
      <motion.button
        id="dark-mode-toggle"
        onClick={toggleDarkMode}
        data-tooltip-id="dark-mode-toggle-tooltip"
        data-tooltip-content="Toggle dark mode"
        className="flex items-center justify-center rounded-full bg-primary-700 p-2 shadow-md transition-colors duration-300 dark:bg-primary-100"
