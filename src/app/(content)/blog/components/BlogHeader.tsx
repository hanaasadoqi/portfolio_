...
const BlogHeader: React.FC<BlogHeaderProps> = ({
  ...
  return (
    <header className="z-10 mb-4 dark:drop-shadow-xl relative w-full bg-cover bg-center h-64 text-white flex flex-col justify-center items-center"
      ...
      <div className="relative w-full h-full flex flex-col items-center px-6 pt-8 text-center md:pt-12">
        ...
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex flex-wrap w-full justify-center gap-1">
          {tags && tags.map(tag => (
